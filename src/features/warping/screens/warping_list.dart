...
import '../controllers/warping_list_controller.dart';
import '../models/warping.dart';
import 'warping_detail.dart';

// ═════════════════════════════════════════════════════════════
//  WARPING LIST PAGE — status-filtered, search, infinite scroll
// ═════════════════════════════════════════════════════════════
...
class _WarpingListPageState extends State<WarpingListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Expanded(child: _WarpingList(c: c)),
      ]),
    );
  }
  ...
  PreferredSizeWidget _buildAppBar() => AppBar(
        ...
        title: Obx(() => Column(
              ...
              children: [
                const Text('Warping Jobs', style: ErpTextStyles.pageTitle),
                Text(
        ...
        actions: [
          Obx(() => IconButton(
                ...
                onPressed:
                    c.isLoading.value ? null : () => c.fetchList(reset: true),
              )),
        ],
      );
}
...
class _StatusFilterRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Obx(() => SingleChildScrollView(
              ...
              child: Row(
                children: WarpingListController.kStatuses.map((s) {
...
class _WarpingList extends StatelessWidget {
  final WarpingListController c;
  const _WarpingList({required this.c});
      ...
      return RefreshIndicator(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (ctx, i) {
            ...
            return _WarpingCard(item: c.list[i]);
          },
        ),
      );
    });
...
class _WarpingCard extends StatelessWidget {
  final WarpingListItem item;
  const _WarpingCard({required this.item});
                  ...
                  children: [
                    Row(children: [
                      ...
                      if (item.hasPlan) ...[
                        ...
                        _StatusPill(label: 'PLAN', color: ErpColors.accentBlue),
                      ],
                    ]),
...
class _EmptyState extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(
            hasSearch ? 'No matching records' : 'No $status warpings',
            style: const TextStyle(
          ...
          const SizedBox(height: 4),
          const Text('Warping jobs will appear here',
              style: TextStyle(
